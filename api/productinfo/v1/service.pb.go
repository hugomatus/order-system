...
var file_service_proto_rawDesc = []byte{
	...
	0x03, 0x61, 0x70, 0x69, 0x22, 0x65, 0x0a, 0x07, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x12,
	...
	,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*ProductID)(nil), // 1: api.ProductID
}
var file_service_proto_depIdxs = []int32{
	0, // 0: api.ProductInfo.addProduct:input_type -> api.Product
	1, // 1: api.ProductInfo.getProduct:input_type -> api.ProductID
	1, // 2: api.ProductInfo.addProduct:output_type -> api.ProductID
	0, // 3: api.ProductInfo.getProduct:output_type -> api.Product
...
func (c *productInfoClient) AddProduct(ctx context.Context, in *Product, opts ...grpc.CallOption) (*ProductID, error) {
	out := new(ProductID)
	err := c.cc.Invoke(ctx, "/api.ProductInfo/addProduct", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productInfoClient) GetProduct(ctx context.Context, in *ProductID, opts ...grpc.CallOption) (*Product, error) {
	out := new(Product)
	err := c.cc.Invoke(ctx, "/api.ProductInfo/getProduct", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProductInfo_AddProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.ProductInfo/AddProduct",
	}
...
func _ProductInfo_GetProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.ProductInfo/GetProduct",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
